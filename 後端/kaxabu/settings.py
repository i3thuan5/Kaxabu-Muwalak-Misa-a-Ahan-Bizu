"""
Django settings for kaxabu project.
...
SECRET_KEY = 'wyqv*v-+9*gzz&%@kex=wq=p79o5gryoqzl$rchyitr$hn+#39'
...
WSGI_APPLICATION = 'kaxabu.wsgi.application'
