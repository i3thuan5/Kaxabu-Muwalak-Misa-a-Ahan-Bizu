  ...
  <div className="ui center aligned container">
    <div className="ui stackable grid">
      <div className="three wide column">
        <h4 className="ui inverted header">Kaxabu Bizu</h4>
        <div className="ui inverted link list">
          <a className="item" href="https://www.facebook.com/events/1662129040716123/" target="_blank" rel='noopener noreferer'>辭典發表會暨使用說明會</a>
          <a className="item" href="https://github.com/Taiwanese-Corpus/kaxabu-muwalak-misa-a-ahan-bizu" target="_blank" rel='noopener noreferer'>Github</a>
        </div>
      </div>
      <div className="three wide column">
        <h4 className="ui inverted header">社群</h4>
        <div className="ui inverted link list">
      ...
      <div className="seven wide right floated column">
        <h4 className="ui inverted header">Kaxabu 噶哈巫族</h4>
        <p>噶哈巫族為臺灣原住民族之一，目前主要分布於南投縣埔里鎮。噶哈巫族目前主要有四個部落：牛眠山、守城份、大湳、蜈蚣崙，合稱四庄。部落近年來積極進行語言復振。</p>
      </div>
    </div>
